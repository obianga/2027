...
st.markdown("""<h2 style='text-align: center; color: #FF9500; font-size: 28px; font-weight: bold; margin: 40px 0 30px 0; text-shadow: 0 0 10px rgba(255,149,0,0.3);'>Real African Infrastructure Projects</h2>""", unsafe_allow_html=True)
st.markdown("---")
